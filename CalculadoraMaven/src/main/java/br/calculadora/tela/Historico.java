...
private CalculadoraWeb webservice;

    public Historico() {
        initComponents();
        webservice=new CalculadoraWeb();
        List<Calculos> dao=webservice.getAll();
        for(int i=0;i<dao.size();i++){
            Calculos d=dao.get(i);
            DefaultTableModel grid= (DefaultTableModel)tabela.getModel();
            grid.addRow(d.carregarGrid());
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Primeiro valor", "Operacão", "Segundo valor", "Resultado"
            }
        ) {
